    ...
    <div className='min-h-screen flex items-center justify-center px-4'>
      <div className='w-full max-w-md bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl shadow-lg p-8'>
        ...
        <form className="space-y-5" onSubmit={(e) => {
          ...
          <button type='submit' onClick={handleLogin} className=" w-full bg-blue-600 hover:bg-blue-800 text-white py-3 mt-4 rounded-lg shadow-md hover:shadow-lg transition-all hover:cursor-pointer duration-300 font-semibold">
              Login
          </button>
